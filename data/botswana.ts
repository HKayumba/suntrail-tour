...
export const info = [
  { label: "Superficie", value: "581 730 km²" },
  { label: "Population", value: "≈ 2,7 millions" },
  { label: "Animal emblématique", value: "Éléphant d'Afrique" },
  { label: "Territoire protégé", value: "≈ 38 %" },
];
...
export const sites = [
  {
    ...
    location: "Nord-Ouest Botswana · Site UNESCO",
    image: "/assets/images/destination/botswana/okavango.png",
    text: "Véritable joyau du Botswana, le delta de l'Okavango est l'un des écosystèmes les plus extraordinaires d'Afrique. Cet immense labyrinthe de canaux, d'îles et de lagunes attire une faune spectaculaire et offre des safaris uniques en 4x4, en bateau ou en mokoro, la pirogue traditionnelle.",
    experiences:
      "Safari en mokoro, safari à pied, croisière au coucher du soleil, observation des oiseaux.",
  },
  {
    title: "Parc national de Chobe",
    badge: "Safari",
    location: "Nord Botswana · Rivière Chobe",
    image: "/assets/images/destination/botswana/chobe2.png",
    text: "Situé au nord du pays, Chobe est célèbre pour abriter l'une des plus grandes concentrations d'éléphants d'Afrique — plus de 50 000 individus. Le long de la rivière, les safaris en bateau permettent d'observer une faune abondante dans un cadre spectaculaire.",
    experiences:
      "Safari en bateau, safari 4x4, coucher de soleil sur la rivière, observation des éléphants.",
  },
  {
    title: "Réserve de Moremi",
    badge: "Prédateurs",
    location: "Okavango · Concession privée",
    image: "/assets/images/destination/botswana/reserve moremi.png",
    text: "Nichée entre terre ferme et zones inondées, la réserve de Moremi offre une diversité de paysages exceptionnelle et des safaris parmi les plus riches du pays. C'est l'un des meilleurs endroits au monde pour observer lions, léopards et lycaons dans leur habitat naturel.",
    experiences:
      "Safari 4x4, observation des grands prédateurs, photographie animalière.",
  },
  {
    title: "Makgadikgadi Pans",
    badge: "Désert de sel",
    location: "Centre-Est Botswana",
    image: "/assets/images/destination/botswana/makgadikgadi.png",
    text: "Ces immenses étendues salines, vestiges d'un ancien lac préhistorique, offrent des paysages surréalistes et une atmosphère hors du temps. Pendant la saison sèche, l'expérience y est presque lunaire. En saison des pluies, les pans attirent zèbres et flamants roses.",
    experiences:
      "Nuit sous les étoiles, rencontre avec les suricates, quad sur les pans, migration des zèbres.",
  },
  {
    title: "Désert du Kalahari",
    badge: "Culturel",
    location: "Centre & Sud Botswana",
    image: "/assets/images/destination/botswana/desert_kalahari.png",
    text: "Le Kalahari dévoile une autre facette du Botswana : plus aride, plus silencieuse, plus spirituelle. C'est une terre de contrastes où vivent les San (Bushmen), gardiens d'un savoir ancestral fascinant, hérité de milliers d'années de vie en harmonie avec la nature.",
    experiences:
      "Découverte culturelle avec les San, safari dans le désert, observation des étoiles.",
  },
  {
    title: "Okavango Panhandle",
    badge: "Oiseaux",
    location: "Nord-Ouest · Rivière Okavango",
    image: "/assets/images/destination/botswana/panhandle.png",
    text: "La zone du Panhandle, où la rivière Okavango coule encore droite avant de se disperser dans le delta, est un paradis pour les pêcheurs et les ornithologues. Les bateaux locaux naviguent sur des eaux paisibles bordées de papyrus, au milieu d'une faune aviaire exceptionnelle.",
    experiences:
      "Pêche au tigre, observation des oiseaux, navigation tranquille, hérons, aigrettes et martins-pêcheurs.",
  },
];
...
export const uniqueness = [
  {
    ...
    iconHoverBgColor: "group-hover:bg-teal-600",
    iconColor: "text-teal-600",
    iconHoverColor: "group-hover:text-white",
    borderColor: "from-teal-600/0 via-teal-600 to-teal-600/0",
  ...
  },
  {
    ...
    iconHoverBgColor: "group-hover:bg-cyan-600",
    iconColor: "text-cyan-600",
    iconHoverColor: "group-hover:text-white",
    borderColor: "from-cyan-600/0 via-cyan-600 to-cyan-600/0",
  ...
  },
  {
    ...
    iconHoverBgColor: "group-hover:bg-amber-700",
    iconColor: "text-amber-700",
    iconHoverColor: "group-hover:text-white",
    borderColor: "from-amber-700/0 via-amber-700 to-amber-700/0",
  ...
  },
  {
    ...
    iconHoverBgColor: "group-hover:bg-orange-600",
    iconColor: "text-orange-600",
    iconHoverColor: "group-hover:text-white",
    borderColor: "from-orange-600/0 via-orange-600 to-orange-600/0",
  ...
  },
  {
    ...
    iconHoverBgColor: "group-hover:bg-indigo-500",
    iconColor: "text-indigo-500",
    iconHoverColor: "group-hover:text-white",
    borderColor: "from-indigo-500/0 via-indigo-500 to-indigo-500/0",
  ...
  },
  {
    ...
    iconHoverBgColor: "group-hover:bg-emerald-600",
    iconColor: "text-emerald-600",
    iconHoverColor: "group-hover:text-white",
    borderColor: "from-emerald-600/0 via-emerald-600 to-emerald-600/0",
...
export const chooseReasons = [
  ...
  },
  {
    ...
    iconHoverColor: "group-hover:text-white",
    borderColor: "from-amber-600/0 via-amber-600 to-amber-600/0",
  ...
  },
  {
    ...
    iconHoverColor: "group-hover:text-white",
    borderColor: "from-rose-600/0 via-rose-600 to-rose-600/0",
...
export const circuits = [
  {
    title: "Safari Okavango & Chobe",
    badge: "Best-seller",
    duration: "10 jours",
    image: "/assets/images/about/01.webp",
    region: "Nord Botswana",
    text: "De l'Okavango à Chobe en passant par Moremi — le grand classique du Botswana pour une immersion totale dans les deux plus beaux écosystèmes du pays.",
    price: "3 990 €",
  },
  {
    title: "Okavango Delta Exclusif",
    badge: "Luxe",
    duration: "7 jours",
    image: "/assets/images/about/01.webp",
    region: "Okavango",
    text: "Une semaine dans les plus beaux camps du delta — mokoro, safari à pied et 4x4 dans des concessions privées. L'expérience Okavango dans toute son intimité.",
    price: "4 890 €",
  },
  {
    title: "Grand Tour Botswana",
    badge: "Complet",
    duration: "14 jours",
    image: "/assets/images/about/01.webp",
    region: "Botswana",
    text: "Okavango, Moremi, Chobe, Makgadikgadi et Kalahari — un tour complet du Botswana pour vivre chaque facette de ce pays d'exception, de l'eau au désert.",
    price: "5 990 €",
  },
  {
    ...
    duration: "12 jours",
    image: "/assets/images/about/01.webp",
    region: "Botswana · Zimbabwe",
    text: "Le meilleur du Botswana — Okavango et Chobe — combiné avec le spectacle incomparable des Chutes Victoria au Zimbabwe. Un voyage inoubliable entre eau et wilderness.",
    price: "4 490 €",
  },
];
...
export const accommodations = [
  {
    title: "Mombo Camp",
    subtitle: "Mombo Camp — Moremi",
    location: "Moremi · Concession privée",
    category: "Camp de luxe exclusif",
    text: "Régulièrement élu meilleur camp d'Afrique, Mombo est positionné à la pointe nord de la Chief's Island dans la réserve de Moremi. Renommé pour ses densités exceptionnelles de prédateurs — lion, léopard et lycaon — et pour la qualité inégalée de ses guides naturalistes.",
  },
  {
    title: "Xigera Safari Lodge",
    subtitle: "Xigera Safari Lodge — Okavango",
    location: "Okavango · Delta central",
    category: "Lodge éco-luxe",
    text: "Récompensé pour son architecture spectaculaire et son engagement environnemental exemplaire, Xigera trône au cœur du delta. Ses 12 suites suspendues dans les arbres, reliées par des passerelles aériennes, offrent une connexion unique avec l'écosystème de l'Okavango.",
  },
  {
    title: "Zarafa Camp",
    subtitle: "Zarafa Camp — Selinda",
    location: "Selinda · Réserve privée",
    category: "Camp ultra-exclusif",
    text: "Quatre tentes-suites luxueuses nichées sur les rives de la rivière Zibadianja, au cœur d'une concession privée de 130 000 hectares. Safari en 4x4, à pied, en bateau et en mokoro dans un environnement d'une richesse faunique exceptionnelle.",
  },
  {
    title: "Jack's Camp",
    subtitle: "Jack's Camp — Makgadikgadi",
    location: "Makgadikgadi · Pans de sel",
    category: "Camp vintage iconic",
    text: "Légendaire camp vintage en toile tendue au bord des pans de Makgadikgadi, là où les explorateurs africains campaient il y a un siècle. Rencontres avec les suricates, nuit sur les pans, quad au lever du soleil et observation des étoiles dans un silence absolu.",
  },
  {
    title: "DumaTau Camp",
    subtitle: "DumaTau Camp — Chobe",
    location: "Linyanti · Corridor de Chobe",
    category: "Camp",
    text: "Positionné sur la rive de la rivière Linyanti, face au parc national de Chobe, DumaTau bénéficie d'une position stratégique pour observer les migrations d'éléphants. Safaris en bateau, à pied et en 4x4 dans l'une des zones les plus riches du nord Botswana.",
  },
];
